...
class EnhancedSemanticSearchService {
  ...
  final Map<String, List<String>> _conceptMappings = {
    'stress': ['anxiety', 'pressure', 'tension', 'worry', 'burden', 'overwhelm', 'strain', 'hair pulling', 'trichotillomania', 'nail biting', 'skin picking', 'fidgeting', 'panic attack', 'racing heart', 'chest tight', 'cant breathe', 'nervous habit', 'compulsive', 'obsessive'],
    'work': ['career', 'job', 'profession', 'employment', 'business', 'duty', 'dharma', 'toxic boss', 'quit job', 'lost job', 'fired', 'harassment', 'bullying', 'burnout', 'workplace', 'coworker', 'micromanage', 'overwork'],
    'family': ['parents', 'children', 'siblings', 'relatives', 'household', 'home', 'narcissistic parent', 'toxic family', 'abuse', 'neglect', 'divorce', 'custody', 'estranged'],
    'relationships': ['love', 'marriage', 'friendship', 'partner', 'spouse', 'connection', 'fight with wife', 'fight with husband', 'betrayal', 'trust issues', 'toxic relationship', 'breakup', 'cheating', 'affair'],
    'purpose': ['meaning', 'dharma', 'calling', 'mission', 'goals', 'direction', 'vision', 'lost purpose', 'meaningless', 'why am i here', 'life purpose'],
    'spiritual': ['meditation', 'prayer', 'divine', 'soul', 'consciousness', 'enlightenment', 'lost faith', 'doubt god', 'spiritual crisis'],
    'fear': ['afraid', 'scared', 'terror', 'phobia', 'anxiety', 'dread', 'worry', 'panic', 'terrified', 'nightmare'],
    'anger': ['rage', 'fury', 'irritation', 'frustration', 'annoyance', 'wrath', 'explosive', 'yelling', 'fighting', 'resentment'],
    'confusion': ['lost', 'unclear', 'doubt', 'uncertain', 'perplexed', 'puzzled', 'dont know', 'confused', 'overwhelmed'],
    'success': ['achievement', 'accomplishment', 'victory', 'triumph', 'prosperity', 'winning', 'successful'],
    'failure': ['defeat', 'loss', 'setback', 'disappointment', 'mistake', 'error', 'failing', 'failed', 'loser'],
    'money': ['wealth', 'finance', 'prosperity', 'poverty', 'income', 'financial', 'debt', 'broke', 'bankrupt', 'cant pay bills', 'no money', 'poor', 'rich'],
    'health': ['illness', 'disease', 'medical', 'wellness', 'fitness', 'healing', 'chronic pain', 'sick', 'injury', 'disability', 'cant sleep', 'insomnia', 'not eating', 'appetite loss', 'exhausted', 'fatigue', 'fall down', 'mobility'],
    'death': ['dying', 'mortality', 'grief', 'loss', 'bereavement', 'mourning', 'terminal illness', 'death of child', 'death of parent', 'miscarriage', 'suicide'],
    'ethics': ['morality', 'values', 'principles', 'right', 'wrong', 'virtue', 'guilt', 'shame', 'forgiveness'],
    'choice': ['decision', 'option', 'selection', 'dilemma', 'pick', 'choose', 'should i', 'what do i do'],
    'depression': ['depressed', 'sad', 'hopeless', 'worthless', 'suicidal thoughts', 'no energy', 'cant get out of bed', 'crying', 'empty', 'numb'],
    'behavioral': ['procrastination', 'lying', 'cheating', 'stealing', 'addiction', 'gambling', 'drinking', 'drugs', 'self harm', 'cutting'],
  };
