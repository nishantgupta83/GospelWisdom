...
// in GospelWisdom/test/services/background_music_service_test.dart.
...
class MockAudioPlayer extends _i1.Mock implements _i2.AudioPlayer {
  ...
  @override
  _i3.Stream<_i2.PlayerEvent> get playerEventStream => (super.noSuchMethod(
  ...
  @override
  _i3.Stream<_i2.PlayerException> get errorStream => (super.noSuchMethod(
  ...
  @override
  _i3.Future<void> removeAudioSourceAt(int? index) => (super.noSuchMethod(
        Invocation.method(
          #removeAudioSourceAt,
          [index],
        ),
  ...
  @override
  _i3.Future<void> removeAudioSourceRange(
    int? start,
    int? end,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<void> moveAudioSource(
    int? currentIndex,
    int? newIndex,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<void> clearAudioSources() => (super.noSuchMethod(
        Invocation.method(
          #clearAudioSources,
          [],
        ),
